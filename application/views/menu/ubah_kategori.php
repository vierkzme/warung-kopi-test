    ...
    <div class="row">
        <div class="col-lg-6">
            <?php if (validation_errors()) {
                ...
                redirect('menu/ubahKategori/' . $k['id']);
            } ?>
            <?php foreach ($kategori as $k) { ?>
                <form action="<?= base_url('menu/ubahKategori'); ?>" method="post">
                    <div class="form-group">
                        <input type="hidden" name="id" id="id" value="<?php echo $k['id']; ?>">
                        <input type="text" class="form-control form-control-user" id="kategori" name="kategori" placeholder="Masukkan Kategori Menu" value="<?= $k['kategori']; ?>">
                    </div>
                    <div class="form-group">
