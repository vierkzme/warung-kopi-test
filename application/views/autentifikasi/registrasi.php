                ...
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('autentifikasi/registrasi'); ?>">
                            ...
                            <button type="submit" class="btn btn-success btn-user btn-block"> Daftar Menjadi Member </button>
                        </form>
                        <hr>
                        <div class="text-center">
                            <a class="medium" href="<?= base_url('autentifikasi/lupaPassword'); ?>">Lupa Password?</a>
                        </div>
                        <div class="text-center"> Sudah Menjadi Member?<a class="medium" href="<?= base_url('autentifikasi'); ?>"> Login!</a>
                        </div>
                    </div>
                </div>
            </div>
